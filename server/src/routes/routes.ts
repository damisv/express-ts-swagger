...
export function RegisterRoutes(app: express.Express) {
    ...
    app.post('/api/v1/companies',
        ...
        function(request: any, response: any, next: any) {
            const args = {
                body: { "in": "body", "name": "body", "required": true, "ref": "CompanyCreationParams" },
            };
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.patch('/api/v1/companies/:companyID',
        authenticateMiddleware([{ "jwt": ["admin"] }]),
        function(request: any, response: any, next: any) {
            const args = {
                companyID: { "in": "path", "name": "companyID", "required": true, "dataType": "double" },
                body: { "in": "body", "name": "body", "required": true, "ref": "CompanyUpdateParams" },
            };
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.delete('/api/v1/companies/:companyID',
        authenticateMiddleware([{ "jwt": ["admin"] }]),
        function(request: any, response: any, next: any) {
            const args = {
                companyID: { "in": "path", "name": "companyID", "required": true, "dataType": "double" },
    ...
    app.post('/api/v1/employees',
        ...
        function(request: any, response: any, next: any) {
            const args = {
                body: { "in": "body", "name": "body", "required": true, "ref": "EmployeeCreationParams" },
            };
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.patch('/api/v1/employees/:employeeID',
        authenticateMiddleware([{ "jwt": ["admin"] }]),
        function(request: any, response: any, next: any) {
            const args = {
                employeeID: { "in": "path", "name": "employeeID", "required": true, "dataType": "double" },
                body: { "in": "body", "name": "body", "required": true, "ref": "EmployeeUpdateParams" },
            };
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.delete('/api/v1/employees/:employeeID',
        authenticateMiddleware([{ "jwt": ["admin"] }]),
        function(request: any, response: any, next: any) {
            const args = {
                employeeID: { "in": "path", "name": "employeeID", "required": true, "dataType": "double" },
